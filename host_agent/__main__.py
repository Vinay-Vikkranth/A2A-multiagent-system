...
from health_care_multiagent.host_agent.routing_agent import (
...
async def get_response_from_agent(
    ...
    # """Send and Get response from host agent."""
    try:
        # user message is parted and sent to the agent through the runner
        ...
        async for event in event_iterator:
            if event.content and event.content.parts:
                for part in event.content.parts:
                    # if function is called - shows the function call details
                    ...
                    # if function response is received - shows the response details
            ...
            # when agent is done, it prints the final response
...
# user interface
    with gr.Blocks(
        ...
        gr.Image(
            'health_care_multiagent\\host_agent\\static\\medical-logo.jpeg',
            width=100,
            height=100,
            scale=0,
            show_label=False,
        ...
        gr.ChatInterface(
            ...
            description='This assistant can help you suggest diet plan and sleep schedule',
        )
